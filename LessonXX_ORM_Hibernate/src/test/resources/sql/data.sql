...
INSERT INTO DISH (NAME, CUISINE) VALUES ('BLINI', 'RUSSIAN');
...
--BLINI: MILK - 500 MILLILITER, WHEAT FLOUR - 300 GRAM, CHICKEN EGGS - 2 PIECES
INSERT INTO DISH_PRODUCT (DISH_ID, PRODUCT_ID, QUANTITY) VALUES (
    SELECT ID FROM DISH WHERE NAME = 'BLINI',
    SELECT ID FROM PRODUCT WHERE NAME = 'WHEAT FLOUR',
    300
);
INSERT INTO DISH_PRODUCT (DISH_ID, PRODUCT_ID, QUANTITY) VALUES (
